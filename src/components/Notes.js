...
function Notes(props) {
    ...
    const [note, setsNote] = useState({id:"",etitle:"",edescription:"",etag:""});
    
    const updateNote = (currentNote) => {
        ref.current.click();
        setsNote({id: currentNote._id, etitle:currentNote.title, edescription:currentNote.description, etag:currentNote.tag})
    ...
    const onchange = (e)=>{
        setsNote({...note, [e.target.name]:e.target.value})
    }
